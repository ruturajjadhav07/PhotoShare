  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="col-md-5 d-flex flex-column justify-content-center text-center text-md-left" style={{ height: "100%" }}>
          <h1 style={{ fontSize: "3rem", fontWeight: "bold", color: "#0d6efd", textShadow: "2px 2px 8px rgba(0,0,0,0.2)" }}>
            Welcome to <b>photoShare</b>
          </h1>
          <p style={{ fontSize: "1.2rem", color: "#555", lineHeight: "1.5" }}>
            Discover, share, and connect through the beauty of photography. Join
            the community and share your moments with the world.
          </p>
          <h1 style={{ fontSize: "2.5rem", color: "#FF6347", fontWeight: "bold", marginTop: "30px", textShadow: "2px 2px 8px rgba(0,0,0,0.2)" }}>
